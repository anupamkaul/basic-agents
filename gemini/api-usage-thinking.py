...
# for a thinking budget see https://ai.google.dev/gemini-api/docs/thinking#set-budget 
    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                ...
                thinking_config=types.ThinkingConfig(thinking_budget=-1) # Enables thinking (0 to 24576 tokens, gemini 2.5 flash)
            ),
        )
